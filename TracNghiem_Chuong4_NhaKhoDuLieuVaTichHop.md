...
A. Xóa toàn bộ outlier bằng tay  
...
A. Không có bản ghi nào trùng nhau  
...
B. Tính Z-score cho dữ liệu ngoại lai  
...
B. Tính Jaccard giữa hai tập kỹ năng  
...
C. Chỉ phát hiện outlier bằng IQR  
...
A. Dùng Jaccard để so sánh tập hợp  
...
A. Luôn làm mất mọi thông tin thống kê  
