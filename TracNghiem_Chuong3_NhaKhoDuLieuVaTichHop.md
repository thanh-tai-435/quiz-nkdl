...
B. Sự kiện cần xử lý ngay khi phát sinh  
...
D. Không cần checkpointing  

**Câu 32.** Windowing trong streaming dùng để làm gì?

A. Nén dữ liệu thành file zip  
...
C. Chỉ phù hợp với báo cáo cuối ngày  
...
B. Monitoring luôn truy vết lineage tốt hơn  
...
C. Mã SQL nào được macro sinh ra  
